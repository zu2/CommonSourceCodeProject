CommonSourceCodeProject (fork)

This is a fork of Common Source Code Project by Toshiya Takeda.
It focuses on improving the eBASICMasterJr (bmjr) emulator for the BASIC Master Jr. (MB-6885).
The source code for other machines is unchanged.
